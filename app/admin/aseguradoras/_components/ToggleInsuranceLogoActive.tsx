...
import { toggleInsuranceLogoActive } from '@/app/admin/actions'

export default function ToggleInsuranceLogoActive({
  id,
  active,
}: {
  id: string
  ...
  const handleToggle = () => {
    startTransition(async () => {
      const result = await toggleInsuranceLogoActive(id, isActive)
